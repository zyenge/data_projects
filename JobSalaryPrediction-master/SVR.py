...
feature_num=range(1100)
feature_num=feature_num[100:1100:100]
MAE_list=[]
for num in feature_num:
  selector=feature_selection.SelectKBest(score_func=feature_selection.f_regression,k=num)
